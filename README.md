...
First you will need to bootstrap your desired AWS region. Then you will need to create a Github repository and put the code inside.
...
Then, run the following script to push the code to your github repository and bootstrap your account:

```
export GITHUB_URL=clone-url
```
```
export REPO_BRANCH=main
```
```
export CONNECTION_ARN=connection-arn
```
```
export REPO_STRING=owner/repo_name
```
NOTE: replace the `GITHUB_URL` with the clone URL of your Github repository. Replace `CONNECTION_ARN` with your AWS CodeConnections connection arn.
```
